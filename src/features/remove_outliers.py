...
dataset.loc[dataset["gyro_x_outlier"], "gyro_x"] = np.nan
...
for col in outliers_columns:
    for label in df["label"].unique():
        ...
        print("Removed {n_outliers} from {col} for {label}")
...
outliers_removed_df.to_pickle("../../data/interim/02_data_outliers_removed_chauvenets.pkl")
outliers_removed_df.to_csv("../../data/interim/02_data_outliers_removed_chauvenets.csv")