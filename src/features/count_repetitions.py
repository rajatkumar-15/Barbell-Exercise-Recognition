...
#visualize data and indentify patterns
plot_df = squat_df
plot_df[plot_df["set"] == plot_df["set"].unique()[0]].plot(y="acc_x")
plot_df[plot_df["set"] == plot_df["set"].unique()[0]].plot(y="acc_y")
plot_df[plot_df["set"] == plot_df["set"].unique()[0]].plot(y="acc_z")
plot_df[plot_df["set"] == plot_df["set"].unique()[0]].plot(y="acc_r")

plot_df[plot_df["set"] == plot_df["set"].unique()[0]].plot(y="gyro_x")
plot_df[plot_df["set"] == plot_df["set"].unique()[0]].plot(y="gyro_y")
plot_df[plot_df["set"] == plot_df["set"].unique()[0]].plot(y="gyro_z")
plot_df[plot_df["set"] == plot_df["set"].unique()[0]].plot(y="gyro_r")

# Configure LowPassFilter
# ... (rest of the LowPassFilter configuration code)

fs = 1000 / 200
LowPass = LowPassFilter()

# Apply and tweak LowPassFilter
# ... (rest of the LowPassFilter application code)
...
#create fucntion to count repetitions
...
rep.df.groupby(["label","category"])["reps","reps_pred"].mean().plot.bar()